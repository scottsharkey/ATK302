...
function setup() {
  ...
  let url = '1w_cmxmvl1_DGsS1SvGqPTlZl5P2oqCUnN-47MIvuotk'; // this is KEY of the URL from the sheet
  let settings = {
...
function gotData(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    namesArray.push(new Gnomes(data[i].Name, data[i].Gnomes)) ;
   }
...
// my circle class
function Gnomes(myName, myShape) {
